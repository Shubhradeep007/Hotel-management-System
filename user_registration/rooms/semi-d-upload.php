    ...
    if($error === 0 && $error1 === 0){
        if ($img_size > 1250000 && $img_size1 > 1250000) {
            ...
            if (in_array($img_ex_lc,$allowed_exs,$img_ex_lc1)) {
                ...
                $img_upload_path = 'sami-d-pic/'.$new_ing_name;
                $img_upload_path1 = 'sami-d-pic/'.$new_ing_name1;
