...
<style>
body{
    background-image: url(../user_registration/images/bg-1.jpg);
    display: flex;
    text-align: center;
    align-items: center;
...
//    $price = $_POST['price'];
   ...
   // $rm  = $_POST['rm'];
    ...
    if($error === 0 && $error1 === 0){
        if ($img_size > 1250000 && $img_size1 > 1250000 && $_POST['rt'] == 'Delux') {
            ...
            if (in_array($img_ex_lc,$allowed_exs,$img_ex_lc1)) {
                ...
                $img_upload_path1 = 'uploads/'.$new_ing_name1;
